...
fn add_keybinds(help: &ModeInfo) -> Keygroups {
    ...
    let new_pane = if new_pane_keys.is_empty() {
        ...
        style_key_with_modifier(&new_pane_keys, &help.style.theme.styling, None)
    };
    ...
    let resize = if resize_keys.is_empty() {
        ...
        style_key_with_modifier(&resize_keys, &help.style.theme.styling, None)
    };
    ...
    let arrows = style_key_with_modifier(&arrows, &help.style.theme.styling, None);
    let letters = style_key_with_modifier(&letters, &help.style.theme.styling, None);
